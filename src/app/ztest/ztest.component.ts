...
export class ZtestComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    let dataValue = this.formate_data(this.devlopPresent)
      ...
      Object.entries(elemData).forEach((elem) => {
          ...
          Object.entries(elemeData).forEach((eleme)=>{
            this.question1 = [];
              ...
              let score = {
                  country_1:this.country1[0],
                  country_2:this.country1[1],
